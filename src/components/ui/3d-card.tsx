...
export const CardContainer = ({
  ...
  useEffect(() => {
    ...
    containerRef.current.style.transform = `rotateY(${initialRotateY}deg) rotateX(${initialRotateX}deg)`;
  }, [initialRotateX, initialRotateY]);
...
export const CardItem = ({
  ...
  useEffect(() => {
    handleAnimations();
  }, [isMouseEntered]); // handleAnimations is stable
